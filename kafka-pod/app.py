...
def produce_kafka_message():
    ...
    bootstrap_servers = 'kafka-1.kafka-headless.default.svc.cluster.local:9092,kafka-0.kafka-headless.default.svc.cluster.local:9092,kafka-2.kafka-headless.default.svc.cluster.local:9092'  # Replace with your Kafka broker addresses

    # Create a Kafka producer instance
    producer = KafkaProducer(bootstrap_servers=bootstrap_servers)

    # Produce a message
    topic = 'my-topic'  # Replace with the desired topic name
    message = 'Hello, Kafka!'  # Message to be produced
...
def consume_kafka_message():
    # Kafka broker configuration
    bootstrap_servers = 'kafka.default.svc.cluster.local:9092'  # Replace with your Kafka broker addresses
    group_id = 'my-consumer-group'  # Consumer group ID

    # Create a Kafka consumer instance
    consumer = KafkaConsumer(bootstrap_servers=bootstrap_servers, group_id=group_id, auto_offset_reset='earliest')
    ...
    try:
        ...
        # Stop consuming and close the consumer gracefully
        consumer.close()
